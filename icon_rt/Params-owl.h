...
= {
   ...
   { "volume.cubql.handle", OWL_USER_TYPE(bvh_t), OWL_OFFSETOF(LaunchParams,volume.cubql.handle) },
   ...
   { "volume.gridAccel.maxOpacities", OWL_RAW_POINTER, OWL_OFFSETOF(LaunchParams,volume.gridAccel.maxOpacities) },
